...
salary_pipeline = Pipeline([
    ...
    ('mapper_exp', pp.Mapper(
        variables=config.model_config.EXPERIENCE_VARS, mappings=config.model_config.DICT_EXPERIENCE_ORDERED_LEVELS)),

    ('mapper_age', pp.Mapper(
        variables=config.model_config.AGE_VARS, mappings=config.model_config.DICT_AGE_ORDERED_LEVELS)),
    ...
    ('gradient_boosting', GradientBoostingRegressor(n_estimators = config.model_config.n_estimators,
