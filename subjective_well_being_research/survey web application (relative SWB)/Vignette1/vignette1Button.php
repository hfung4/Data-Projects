...
//The purpose of this module is to send the $_POST clicked button status/timestamp to SQL database
...
$vigBt1Array[$keys[0]] = $_POST[$keys[0]];
//update mysql row
sqlRowUpdate('USA_responses_2017', $vigBt1Array, $_POST['ID']);
