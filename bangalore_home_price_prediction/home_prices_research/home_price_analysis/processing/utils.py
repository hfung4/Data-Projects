...
def process_total_sqft(input_str:str)->float:
    ...
    # search to see if input string has "Sq. Meter"
        ...
        return config.model_config.SQFT_PER_SQ_METER * float(re.sub(pattern, '', input_str))
    ...
    # search to see if input string has "Sq. Yards"
        ...
        return config.model_config.SQFT_PER_SQ_YARD * float(re.sub(pattern, '', input_str))
